      ...
      <div className="bg-[#1C4670] pt-12 pb-24 relative -z-30">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mx-2 m-auto sm:mx-0">
            <div className="max-w-xl justify-self-center -z-20">
                ...
                <div>
                    <h3 className="text-white text-xl mb-4">Get the App</h3>
                    ...
                    >
                        <svg className="w-[32px] h-[32px] mr-3" viewBox="0 0 24 24" fill="#A5C937">
                    ...
                    <a 
                        ...
                        className="flex items-center bg-white text-black px-6 py-3 rounded-lg hover:bg-gray-100 transition-colors"
                    >
                        <svg className="w-8 h-8 mr-3" viewBox="0 0 24 24" fill="#A5C937">
